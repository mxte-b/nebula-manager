    ...
    return (
        ...
        >
            <div className="unlock-screen-bg">
                <FloatingIcon.ShieldLock x={"5%"} y={"70%"} rotation={-10} size={160} color={"#b4439c"} opacity={0.15} blurPx={5} />
                <FloatingIcon.ShieldLock x={"15%"} y={"45%"} rotation={10} size={100} color={"#915483"} opacity={0.1}/>
                <FloatingIcon.ShieldLock x={"8%"} y={"25%"} rotation={-5} size={60} color={"#6b5666"} opacity={0.07} blurPx={1} />

                <FloatingIcon.Key x={"82%"} y={"22%"} rotation={-10} size={70} color={"#6b5666"} opacity={0.07} blurPx={1} />
                <FloatingIcon.Key x={"75%"} y={"45%"} rotation={5} size={100} color={"#915483"} opacity={0.1} />
                <FloatingIcon.Key x={"80%"} y={"68%"} rotation={8} size={200} color={"#b4439c"} opacity={0.15} blurPx={5} />
            </div>
